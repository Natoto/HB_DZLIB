...
- (void)createNameButtons
{
    ...
    float height=_topScrollView.frame.size.height-LINE_LAYERBOARDWIDTH;
    float width=_topScrollView.frame.size.width;
    ...
    [_topScrollView addSubview:bottomBorder];
...
{
    UIButton_RedPoint *button = (UIButton_RedPoint  *)[_topScrollView viewWithTag:index + 100];
    button.showpoint = YES;
